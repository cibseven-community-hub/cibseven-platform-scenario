package org.cibseven.community.scenario.cucumber;
  ...
  protected void finish(TestCaseFinished event) {
    ...
    if (deploymentId != null) {
      ...
      try {
        ...
        Class<?> reportGeneratorClass = Class.forName("org.cibseven.community.scenario.report.cucumber.CamundaCucumberPluginReportGenerator");
