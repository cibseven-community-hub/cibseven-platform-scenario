 ...
 */
public class EscalationEventSubProcessTest extends AbstractTest {
  ...
  @Test
  @Deployment(resources = {"org/camunda/bpm/scenario/test/escalations/EscalationEventSubProcessTest.bpmn"})
  public void testCompleteTask() {

    complete(withVariables("escalate", false));

    Scenario.run(scenario).startByKey("EscalationEventSubProcessTest").execute();
